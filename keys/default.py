...
s_up =      [curses.KEY_UP]         # noqa: E222  курсор вверх
s_down =    [curses.KEY_DOWN]       # noqa: E222  курсор вниз
s_ppage =   [curses.KEY_PPAGE]      # noqa: E222  страница вверх
s_npage =   [curses.KEY_NPAGE]      # noqa: E222  страница вниз
s_home =    [curses.KEY_HOME]       # noqa: E222  в начало
s_end =     [curses.KEY_END]        # noqa: E222  в конец
...
r_prev =    [curses.KEY_LEFT]       # noqa: E222  предыдущее сообщение
r_next =    [curses.KEY_RIGHT]      # noqa: E222  следующее сообщение
r_prep =    [ord("-")]              # noqa: E222  перейти ниже по цепочке ответов
r_nrep =    [ord("=")]              # noqa: E222  вернуться по цепочке ответов
r_up =      [curses.KEY_UP]         # noqa: E222  прокрутка вверх
r_down =    [curses.KEY_DOWN]       # noqa: E222  прокрутка вниз
...
r_home =    [curses.KEY_HOME]       # noqa: E222  в начало сообщения
r_mend =    [curses.KEY_END]        # noqa: E222  в конец сообщения
...
r_quote =   [ord("q"), ord("Q")]    # noqa: E222  ответить с цитированием
...
r_list =    [ord("l"), ord("L")]    # noqa: E222  список сообщений
r_inlines = [ord("z"), ord("Z")]    # noqa: E222  вкл/выкл инлайн-стили _italic_, **bold**, `code`.
r_quit =    [27]                    # noqa: E222  вернуться на экран выбора эхоконференции
