...
Экран чтения эхоконференции:
  ...
  * ! - вкл/выкл режим чтение сообщений только по теме (индикатор '!' в строке состояния) 
...
Экран списка сообщений:
  ...
  * ! - вкл/выкл режим просмотра сообщений только по теме (индикатор '!' в строке состояния)
...
Во время быстрого поиска:
  ...
  * Enter - на экране списка сообщений завершить поиск, оставив только найденное (индикатор '@' в строке состояния) 
